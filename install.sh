...
if [[ "$(uname -s)" == "Darwin" ]]; then
  ...
  brew install git zsh node wget tmux vim yarn nvm awscli aws-elasticbeanstalk jq htop mpv ranger ncdu terraform
...
if [[ "$(uname -s)" == "Linux" ]]; then
  sudo apt update
  sudo apt install -y awscli curl vim build-essential nodejs npm tmux zsh htop jq mpv ranger ncdu telegram-desktop slack-desktop telegram-desktop
